                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">
                            Update Article {{ this.$route.params.idAnnonce }}
                        </h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
...
export default {
    ...
    mounted() {
        ...
        axios
            .get(`/editAnnonces/${this.$route.params.idAnnonce}`) //had articleid jaya mn route
            .then(response => {
    ...
    methods: {
        ...
        updateArticle() {
            //this.$Progress.start();
            this.form
                .post(`/updateAnnonce/${this.$route.params.idAnnonce}`)
                .then(response => {
                    //afficheCategory()
